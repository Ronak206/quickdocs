...
export default function TemplateBuilder({ onBack, onTemplateSaved, initialTemplate }: TemplateBuilderProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      {/* Header with Paper Size Options */}
      ...
      <div className="flex-1 overflow-hidden">
        <PanelGroup direction="horizontal" className="h-full">
          ...
          {/* Resize Handle */}
          <PanelResizeHandle className="w-1 bg-border hover:bg-primary/50 transition-colors flex items-center justify-center group">
          ...
          <Panel defaultSize={30} minSize={20} maxSize={45} className="bg-card border-l">
            <div className="h-full flex flex-col">
              <Tabs defaultValue="properties" value={activeRightTab} onValueChange={setActiveRightTab} className="flex-1 flex flex-col overflow-hidden">
                ...
                <TabsContent value="properties" className="flex-1 overflow-hidden m-0 data-[state=inactive]:hidden">
                  <ScrollArea className="h-full w-full">
                    {renderPropertiesPanel()}
                  </ScrollArea>
                </TabsContent>
                
                <TabsContent value="data" className="flex-1 overflow-hidden m-0 data-[state=inactive]:hidden">
                  <ScrollArea className="h-full w-full">
                    {renderDataFormPanel()}
                  </ScrollArea>
                </TabsContent>
